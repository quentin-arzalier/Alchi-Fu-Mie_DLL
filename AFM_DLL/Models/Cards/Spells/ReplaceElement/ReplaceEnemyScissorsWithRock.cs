...
namespace AFM_DLL.Models.Cards.Spells.ReplaceElement
{
    ...
    /// </summary>
    public class ReplaceEnemyScissorsWithRock : SpellCard
    {
        /// <inheritdoc/>
        public override void ActivateSpell(Board board, bool isBlueSide)
        {
            ...
            {
                scissor.OverrideElement = Element.ROCK;
            }
        }
        ...
        {
            return "Remplace les cartes Ciseaux de l'adversaire par des cartes Pierre.";
        }
        ...
        /// <inheritdoc/>
        public override SpellType SpellType => SpellType.REPLACE_ENEMY_SCISSORS_WITH_ROCK;
    }
}
